...
Registro Civil: Validar Certidão Eletrônica segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [registro_civil_val_cert_eletr@mcp.ai](mailto:registro_civil_val_cert_eletr@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
